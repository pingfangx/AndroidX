...
import com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.LayoutParams;
import com.pingfangx.demo.androidx.activity.view.recyclerview.widget.helper.ItemTouchHelper;
...
/**
 * A {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.LayoutManager} implementation which provides
 * similar functionality to {@link android.widget.ListView}.
 */
public class LinearLayoutManager extends com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     */
    @com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Orientation
    int mOrientation;
     ...
     * {@link #onLayoutChildren(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State)} is run.
     */
     ...
     */
    public LinearLayoutManager(Context context, @com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Orientation int orientation,
     ...
     * RecyclerView.
     * <p>
     * If you are using a {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.RecycledViewPool}, it might be a good idea to set
    ...
    @Override
    public void onDetachedFromWindow(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView view, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler) {
    ...
    /**
     * Sets the orientation of the layout. {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.LinearLayoutManager}
     * will do its best to keep scroll position.
     *
     * @param orientation {@link #HORIZONTAL} or {@link #VERTICAL}
     */
    public void setOrientation(@com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Orientation int orientation) {
     ...
     * When set to true, If {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView} is LTR, than it will
     * layout from RTL, if {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView}} is RTL, it will layout
     * from LTR.
     * <p>
     ...
     *
     * <p>By default, {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.LinearLayoutManager} lays out 1 extra page
     ...
     */
    protected int getExtraLayoutSpace(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
    ...
    @Override
    public void smoothScrollToPosition(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView recyclerView, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state,
            int position) {
        com.pingfangx.demo.androidx.activity.view.recyclerview.widget.LinearSmoothScroller linearSmoothScroller =
     ...
     */
    @Override
    public void onLayoutChildren(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        // layout algorithm:
    ...
    @Override
    public void onLayoutCompleted(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
     ...
     * indices.
     */
    void onAnchorReady(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state,
     ...
     */
    private void layoutForPredictiveAnimations(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, int startOffset,
            int endOffset) {
        ...
        final List<com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ViewHolder> scrapList = recycler.getScrapList();
        final int scrapSize = scrapList.size();
        final int firstChildPos = getPosition(getChildAt(0));
        for (int i = 0; i < scrapSize; i++) {
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ViewHolder scrap = scrapList.get(i);
            if (scrap.isRemoved()) {
                continue;
            }
    ...
    private void updateAnchorInfoForLayout(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state,
     ...
     */
    private boolean updateAnchorFromChildren(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (getChildCount() == 0) {
            return false;
        }
        final View focused = getFocusedChild();
     ...
     */
    private boolean updateAnchorFromPendingData(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (state.isPreLayout() || mPendingScrollPosition == NO_POSITION) {
            return false;
        }
     ...
     */
    private int fixLayoutEndGap(int endOffset, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     * @return The final offset amount for children
     */
    private int fixLayoutStartGap(int startOffset, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     */
    @Override
    public int scrollHorizontallyBy(int dx, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
     ...
     */
    @Override
    public int scrollVerticallyBy(int dy, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        if (mOrientation == HORIZONTAL) {
            return 0;
        }
    ...
    @Override
    public int computeHorizontalScrollOffset(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeVerticalScrollOffset(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeHorizontalScrollExtent(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeVerticalScrollExtent(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeHorizontalScrollRange(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    @Override
    public int computeVerticalScrollRange(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    private int computeScrollOffset(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
    ...
    private int computeScrollExtent(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
    ...
    private int computeScrollRange(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
            boolean canUseExistingSpace, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
    ...
    void collectPrefetchPositionsForLayoutState(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, LayoutState layoutState,
    ...
    @Override
    public void collectAdjacentPrefetchPositions(int dx, int dy, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state,
            LayoutPrefetchRegistry layoutPrefetchRegistry) {
    ...
    int scrollBy(int dy, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
     ...
     */
    private void recycleChildren(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, int startIndex, int endIndex) {
     ...
     *
     * @param recycler Recycler instance of {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView}
     * @param dt This can be used to add additional padding to the visible area. This is used
     * to detect children that will go out of bounds after scrolling, without
     * actually moving them.
     */
    private void recycleViewsFromStart(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, int dt) {
        if (dt < 0) {
            if (DEBUG) {
     ...
     * actually moving them.
     */
    private void recycleViewsFromEnd(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, int dt) {
        final int childCount = getChildCount();
        if (dt < 0) {
            if (DEBUG) {
     ...
     * @see #recycleViewsFromStart(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler, int)
     * @see #recycleViewsFromEnd(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler, int)
     * @see com.pingfangx.demo.androidx.activity.view.recyclerview.widget.LinearLayoutManager.LayoutState#mLayoutDirection
     */
    private void recycleByLayoutState(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, LayoutState layoutState) {
     ...
     * independent from the rest of the {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.LinearLayoutManager}
     ...
     */
    int fill(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, LayoutState layoutState,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, boolean stopOnFocusable) {
    ...
    void layoutChunk(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state,
     ...
     */
    private View findReferenceChildClosestToEnd(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private View findReferenceChildClosestToStart(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return mShouldReverseLayout ? findLastReferenceChild(recycler, state) :
                findFirstReferenceChild(recycler, state);
    }

    private View findFirstReferenceChild(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, 0, getChildCount(), state.getItemCount());
    }

    private View findLastReferenceChild(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, getChildCount() - 1, -1, state.getItemCount());
    }

    // overridden by GridLayoutManager
    View findReferenceChild(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state,
    ...
    private View findPartiallyOrCompletelyInvisibleChildClosestToEnd(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
    ...
    private View findPartiallyOrCompletelyInvisibleChildClosestToStart(
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
    ...
    private View findFirstPartiallyOrCompletelyInvisibleChild(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
        return findOnePartiallyOrCompletelyInvisibleChild(0, getChildCount());
    }

    private View findLastPartiallyOrCompletelyInvisibleChild(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler,
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
     ...
     *
     * @return The adapter position of the first visible item or {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView#NO_POSITION} if
     ...
     * {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView#NO_POSITION} if there aren't any visible items.
     ...
     * are ignored in this method.
     *
     * @return The adapter position of the last visible view or {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView#NO_POSITION} if
     * there aren't any visible items.
     * @see #findLastCompletelyVisibleItemPosition()
     * @see #findFirstVisibleItemPosition()
     */
    ...
    View findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible,
            boolean acceptPartiallyVisible) {
        ensureLayoutState();
        @com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.ViewBounds int preferredBoundsFlag = 0;
        @com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.ViewBounds int acceptableBoundsFlag = 0;
        if (completelyVisible) {
            preferredBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_EQ_PVS
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_EQ_PVE);
        } else {
            preferredBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVE
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVS);
        }
        if (acceptPartiallyVisible) {
            acceptableBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVE
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVS);
        }
    ...
    View findOnePartiallyOrCompletelyInvisibleChild(int fromIndex, int toIndex) {
        ...
        if (mOrientationHelper.getDecoratedStart(getChildAt(fromIndex))
                < mOrientationHelper.getStartAfterPadding()) {
            preferredBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVS | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVS);
            acceptableBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVS
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_LT_PVE);
        } else {
            preferredBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVE | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_LT_PVE);
            acceptableBoundsFlag = (com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVE_GT_PVE
                    | com.pingfangx.demo.androidx.activity.view.recyclerview.widget.ViewBoundsCheck.FLAG_CVS_GT_PVS);
        }
        return (mOrientation == HORIZONTAL) ? mHorizontalBoundCheck
                .findOneViewWithinBoundFlags(fromIndex, toIndex, preferredBoundsFlag,
                        acceptableBoundsFlag) : mVerticalBoundCheck
    ...
    static class LayoutState {
        ...
        /**
         * Equal to {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State#isPreLayout()}. When consuming scrap, if this value
        ...
        /**
         * The most recent {@link #scrollBy(int, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State)}
         * amount.
         */
         ...
         */
        List<com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ViewHolder> mScrapList = null;
         ...
         */
        boolean hasMore(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state) {
         ...
         */
        View next(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.Recycler recycler) {
            if (mScrapList != null) {
