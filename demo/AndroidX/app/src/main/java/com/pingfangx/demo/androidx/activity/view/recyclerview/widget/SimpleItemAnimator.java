 ...
 * API.
 * <p>
 * It uses {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo} to track the bounds information of the Views. If you would like
 * to
 * extend this class, you can override {@link #obtainHolderInfo()} method to provide your own info
 * class that extends {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo}.
 */
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
     ...
     * @see com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ItemAnimator#animateDisappearance(ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     */
     ...
     * @see com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ItemAnimator#animateDisappearance(ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     * @see com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.ItemAnimator#animatePersistence(ViewHolder, ItemHolderInfo, ItemHolderInfo)
