 ...
 * <p>
 * If the {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.LayoutManager} you are using does not implement the
 * {@link com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.SmoothScroller.ScrollVectorProvider} interface, then you must override the
 ...
 */
public class LinearSmoothScroller extends com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.SmoothScroller {
     ...
     */
    @Override
    protected void onTargetFound(View targetView, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, Action action) {
     ...
     */
    @Override
    protected void onSeekTargetStep(int dx, int dy, com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        final com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.LayoutManager layoutManager = getLayoutManager();
