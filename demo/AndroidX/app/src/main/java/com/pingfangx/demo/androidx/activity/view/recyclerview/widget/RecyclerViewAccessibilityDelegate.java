...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    final com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView mRecyclerView;
    final AccessibilityDelegateCompat mItemDelegate;

    public RecyclerViewAccessibilityDelegate(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView recyclerView) {
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
        ...
        info.setClassName(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.class.getName());
        if (!shouldIgnore() && mRecyclerView.getLayoutManager() != null) {
    ...
    public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
        ...
        event.setClassName(com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView.class.getName());
        if (host instanceof com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView && !shouldIgnore()) {
            com.pingfangx.demo.androidx.activity.view.recyclerview.widget.RecyclerView rv = (RecyclerView) host;
